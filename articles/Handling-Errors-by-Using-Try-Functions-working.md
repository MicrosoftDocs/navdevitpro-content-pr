...
A try function cannot have a user-defined return value. A function that is designated as a try function has a Boolean return value \(true or false\), and has the construction `OK:= MyTryFunction`.  
