...
```
GET /businesscentral/companies({id})/salesOrders({id})/salesOrderLines
```
...
```json
GET https://api.businesscentral.dynamics.com/v1.0/api/beta/companies({id})/salesOrders({id})/salesOrderLines
```
