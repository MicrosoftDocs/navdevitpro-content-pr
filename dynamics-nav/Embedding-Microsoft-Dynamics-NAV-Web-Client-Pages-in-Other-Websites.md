...
> [!IMPORTANT]  
> To ensure that the embedded web client works with Google Chrome 80 web browser (targeted release on February 4, 2020), make sure that the Dynamics NAV platform has been upgraded to a recommended update version as outlined described in [Preparing Dynamics NAV for Chrome 80](/dynamics365/business-central/dev-itpro/administration/prepare-for-chrome-samesite).
