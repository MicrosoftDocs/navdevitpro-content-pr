...
**Home** is a default activity button in the navigation pane of [!INCLUDE[navnow](../dynamics-nav/includes/navnow_md.md)] and displays items that link to List Places.  
...
-   Add actions on the Role Center page.  
     ...
     ![Action Designer showing the HomeItems actions](../dynamics-nav/media/NAVRTCHomeItemsActionDesigner.PNG "NAVRTCHomeItemsActionDesigner")  
...
## Hiding and Customizing the Home Button and Items in the [!INCLUDE[nav_windows](../dynamics-nav/includes/nav_windows_md.md)]  
 The **Home** button is always present in the navigation pane and cannot be removed or modified that included its icon. From the [!INCLUDE[nav_windows](../dynamics-nav/includes/nav_windows_md.md)], end\-users and administrators can use customization to change the items under the **Home** button including:  
...
-   Restoring the default Home items as defined in the Action Designer on the Role Center page.  
 ...
 If you are an administrator, then you can open the [!INCLUDE[nav_windows](../dynamics-nav/includes/nav_windows_md.md)] in the Configuration mode and the changes that you make will be implemented on the Role Center for all users. For more information, see [How to: Open Microsoft Dynamics NAV in Configuration Mode](../Topic/How%20to:%20Open%20Microsoft%20Dynamics%20NAV%20in%20Configuration%20Mode.md).  
