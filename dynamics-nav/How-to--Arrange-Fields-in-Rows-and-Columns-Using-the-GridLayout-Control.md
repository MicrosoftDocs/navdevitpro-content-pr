...
-   Show or hide field captions.  
 ...
 The following figure illustrates a page that uses the **GridLayout** control to display fields from table 18, Customer, in the [!INCLUDE[demolong](../dynamics-nav/includes/demolong_md.md)]. The fields are arranged in four rows.  
  
 ![Sales order fields in a grid](../dynamics-nav/media/RTCGridLayoutSalesOrderExample.png "RTCGridLayoutSalesOrderExample")  
  
 The following figure shows Page Designer for the GridLayout example.  
  
 ![Page Designer for GridLayout of sales order](../dynamics-nav/media/PageDesignerGridLayoutSalesOrder.png "PageDesignerGridLayoutSalesOrder")  
...
6.  In the **Properties** window, in the **Value** column of the **Layout** property, choose the drop\-down arrow. Set the [Layout Property](../dynamics-nav/Layout-Property.md) as follows:  
...
## Setting Fields to Span Multiple Rows and Columns  
 ...
 ![GridLayout control with 3 rows and 3 columns](../dynamics-nav/media/NAVGridLayout3rX3c.png "NAVGridLayout3rX3c")  
  
 If you set **Field 2** to span two rows, then the following layout is displayed:  
  
 ![GridLayout control with field that spans 2 rows](../dynamics-nav/media/NAVGridLayoutRowSpan3x3.png "NAVGridLayoutRowSpan3x3")  
 ...
 ![GridLayout control with field that spans 2 columns](../dynamics-nav/media/NAVGridLayoutColSpan3x3.png "NAVGridLayoutColSpan3x3")  
 ...
 ![GridLayout with field that spans 2 row and column](../dynamics-nav/media/NAV_GridLayout_RoxColSpan_3x3.png "NAV\_GridLayout\_RoxColSpan\_3x3")  
  
> [!IMPORTANT]  
>  The [!INCLUDE[nav_web](../dynamics-nav/includes/nav_web_md.md)] does not support row and column spanning for fields. If the page displays in the [!INCLUDE[nav_web](../dynamics-nav/includes/nav_web_md.md)], the fields appear without spanning.  
...
2.  In the **Properties** window, do the following:  
    ...
    -   To set a field to span one or more rows, set the value of the [RowSpan Property](../dynamics-nav/RowSpan-Property.md) to the number of rows.  
  
    -   To set a field to span one or more columns, set the value of the [ColumnSpan Property](../dynamics-nav/ColumnSpan-Property.md) to the number of columns.  
...
2.  In the **Properties** window, set the value of the [ShowCaption Property](../dynamics-nav/ShowCaption-Property.md) to **No**  
