...
## Implementing SIFT  
 ...
 The following is an example of how [!INCLUDE[navnowlong](../dynamics-nav/includes/navnowlong_md.md)] creates an indexed view for a SIFT key that consists of the AccountNo., PostingDate fields and generates the total for the Amount field.  
