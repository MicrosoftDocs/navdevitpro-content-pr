...
Only one tenant can be automatically configured at a time, so the [!INCLUDE[navnow](../dynamics-nav/includes/navnow_md.md)] tenant name needs to be provided as the NavTenant parameter to the `Set-NavSingleSignOnWithOffice365` cmdlet.  
