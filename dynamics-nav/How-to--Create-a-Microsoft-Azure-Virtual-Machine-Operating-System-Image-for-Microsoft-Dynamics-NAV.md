...
2.  Complete the instructions for creating a new virtual machine in [Tutorial: Create and Manage Windows VMs with Azure PowerShell](/azure/virtual-machines/windows/tutorial-manage-vm).
