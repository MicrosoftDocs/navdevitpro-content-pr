...
## Next Steps  
 Simon's next steps are to add the **My Customers** and **My Items** parts to the page. For more information, see [How to: Create a CardPart Page For Displaying Customer Data in a FactBox](How-to--Create%20a%20CardPart%20Page%20For%20Displaying%20Customer%20Data%20in%20a%20FactBox.md).  
