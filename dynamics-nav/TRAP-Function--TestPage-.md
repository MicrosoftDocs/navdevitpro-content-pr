...
## Remarks  
 You can trap only nonmodal pages with the TRAP function. To trap modal pages that you invoke with the [RUNMODAL Function \(Page\)](RUNMODAL-Function--Page-.md) or the [PAGE.RUNMODAL Function](PAGE-RUNMODAL-Function.md), you must use the **ModalFormHandler** function. For more information, see [How to: Create Handler Functions](How-to--Create%20Handler%20Functions.md).  
