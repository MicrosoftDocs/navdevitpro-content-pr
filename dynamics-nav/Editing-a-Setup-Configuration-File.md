...
You create or load Setup configuration files using [!INCLUDE[navnowlong](../dynamics-nav/includes/navnowlong_md.md)] Setup. You can directly edit these XML files.  
...
|Parameter|These settings contain configuration information for components. As with Components, you can modify a parameter’s **Value**, but not its **Id**.<br /><br /> For information about values for pre\-configuring [!INCLUDE[navnow](../dynamics-nav/includes/navnow_md.md)] components using a Setup configuration file, see [Configuring Microsoft Dynamics NAV](../dynamics-nav/Configuring-Microsoft-Dynamics-NAV.md).|  
  
> [!TIP]  
>  [!INCLUDE[navnow](../dynamics-nav/includes/navnow_md.md)] Setup is primarily a tool for installing software, but you can also use it as an editor for creating and modifying Setup configuration files. When you want to edit a Setup configuration file, you have the following options:  
>   
