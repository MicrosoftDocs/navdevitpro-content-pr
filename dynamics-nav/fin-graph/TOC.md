...
### [Post journal](../api/dynamics_journal_post.md)
...
### [Post purchase invoice](../api/dynamics_purchaseinvoice_post.md)
### [Get pdf document](../api/dynamics_purchaseinvoice_pdfdocument.md)
...
### [Get pdf document](../api/dynamics_salesinvoice_pdfdocument.md)
...
### [Get pdf document](../api/dynamics_salescreditmemo_pdfdocument.md)
...
### [Get pdf document](../api/dynamics_salesquote_pdfdocument.md)
