...
### [Create countries/regions](api/dynamics_companies_post_countriesregions.md)
...
### [Create currencies](api/dynamics_companies_post_currencies.md)
...
### [Create customer](api/dynamics_companies_post_customer.md)
