---
title: Update defaultDimensions Item | Microsoft Docs
...
```json
PATCH https://api.businesscentral.dynamics.com/v1.0/api/beta/companies({companyId})/items({itemId})/defaultDimensions({itemId},{dimensionId})
```
