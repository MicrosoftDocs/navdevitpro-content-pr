...
-   URLs that open the page in the [!INCLUDE[nav_windows](../dynamics-nav/includes/nav_windows_md.md)], the [!INCLUDE[nav_web](../dynamics-nav/includes/nav_web_md.md)], and in SOAP and OData web services.  
  
 The following illustration shows a Sales Order page and the About This Page.  
  
 ![About This Page window that shows all fields](../dynamics-nav/media/NAV_Zoom_SalesOrderRTC.png "NAV\_Zoom\_SalesOrderRTC")  
...
>  To see more information about a subpage, such as a Factbox or a Line page, you must use the shortcut for About This Page, CTRL\+ALT\+F1.  
 ...
 ![About This Report page that shows the dataset](../dynamics-nav/media/NAV_Zoom_AboutThisReport.png "NAV\_Zoom\_AboutThisReport")  
