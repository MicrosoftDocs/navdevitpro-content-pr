...
>[!NOTE]
>Also included in the Dynamics NAV Administration Shell are cmdlets for administering extension packages. For more information about these cmdlets, see [Microsoft.Dynamics.Nav.Apps.Management](Microsoft.Dynamics.Nav.Apps.Management.md).
