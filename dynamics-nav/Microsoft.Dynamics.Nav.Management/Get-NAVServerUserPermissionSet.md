...
### -CompanyName
The name of a company in the Microsoft Dynamics NAV database.
If this argument is not included in the cmdlet, users in the default company are returned.
...
### -Sid
Specifies a security identifier (SID) of a Microsoft Dynamics NAV user.
...
### -WindowsAccount
Specifies the Windows user name of a Microsoft Dynamics NAV user.
