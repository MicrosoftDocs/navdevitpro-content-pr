...
5.  In the **Add Service Reference** dialog box, choose the **Advanced** button, choose the **Add Web Reference** button, type or paste the URL that you used when checking the WSDL, such as **https://localhost:7047/DynamicsNAV/WS/Services**, and then choose the green arrow to visit the URL.  
