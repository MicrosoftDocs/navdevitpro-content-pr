...
Create a itemCategory object in [!INCLUDE[d365fin_long_md](../../includes/d365fin_long_md.md)].
...
## Response
If successful, this method returns ```201 Created``` response code and a **itemCategories** object in the response body.
