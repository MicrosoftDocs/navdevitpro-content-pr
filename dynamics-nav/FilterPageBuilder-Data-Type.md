...
description: A filterPageBuilder data type is a complex type that stores filter configurations with one or more filter controls on fields of the underlying table.
ms.custom: na
ms.date: 10/27/2017
ms.reviewer: na
ms.suite: na
