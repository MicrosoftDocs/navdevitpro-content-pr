...
|Collect event trace data in an event trace log \(.etl\) file. Use the event trace monitoring tool to start an event trace session.|[How to: Use Performance Monitor to Collect Event Trace Data](How-to--Use%20Performance%20Monitor%20to%20Collect%20Event%20Trace%20Data.md)<br /><br /> [How to: Use PerfView to Collect Event Trace Data](How-to--Use%20PerfView%20to%20Collect%20Event%20Trace%20Data.md)|  
|View event trace data that is contained in an .etl file.|[How to: Use PerfView to View Event Trace Data](How-to--Use%20PerfView%20to%20View%20Event%20Trace%20Data.md)|  
|Use Event Viewer to collect and view event trace data|[How to: Use Event Viewer to Collect and View Trace Events](How-to--Use%20Event%20Viewer%20to%20Collect%20and%20View%20Trace%20Events.md)|  
