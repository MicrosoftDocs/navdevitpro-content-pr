...
description: "The BREAKONERROR Function (Debugger) sets whether the debugger breaks on errors. This article describes its syntax, property/return value, remarks, and example."
ms.custom: na
ms.date: 06/05/2016
ms.reviewer: na
ms.suite: na
