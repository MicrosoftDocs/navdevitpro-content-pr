...
description: SETRANGE Function (Query)Sets a filter on a range of values on a column of a query dataset.This topic contains information on the SETRANGE Function (Query) syntax, parameters, remarks, and examples.
ms.custom: na
ms.date: 06/05/2016
ms.reviewer: na
ms.suite: na
