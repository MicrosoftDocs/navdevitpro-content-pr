...
## Remarks  
 ...
 The ID is used for reference purposes. As a result, you can use the value of the [Name Property\-duplicate](../dynamics-nav/Name-Property-duplicate.md) to reference objects in your code. The Name is automatically converted to the ID when the code is compiled.  
