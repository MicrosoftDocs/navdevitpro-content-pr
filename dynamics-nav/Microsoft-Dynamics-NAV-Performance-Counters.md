...
### <a name="ActiveSessions"></a>Analyzing # Active sessions
...
For more information about tenants, see [Multitenant Deployment Architecture](Multitenant-Deployment-Architecture.md).
...
*   Keeps the running tasks in the list of active tasks, and adds new tasks as they are ready, until the maximum number of tasks is met.
