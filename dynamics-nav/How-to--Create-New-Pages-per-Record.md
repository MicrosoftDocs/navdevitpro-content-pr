...
For some reports, you may want to print a new page for each new record.  
 ...
 An example of a report that begins a new page for each new record is report 205, Order Confirmation, in the [!INCLUDE[demolong](../dynamics-nav/includes/demolong_md.md)].  
