...
3.  Open an existing permission set for editing or create a new permission set.  
     ...
     For more information about how to create and editing permissions sets, see [How to: Create or Modify Permission Sets](How-to--Create%20or%20Modify%20Permission%20Sets.md).  
...
6.  Assign the permission set to users who require access to the query.  
     ...
     For more information, see [How to: Define Permissions for Users](How-to--Define%20Permissions%20for%20Users.md).  
