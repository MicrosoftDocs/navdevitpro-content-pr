...
-   Microsoft Office Outlook integration. For more information, see [Outlook Add-in-\($ P\_1 Product Name $\) Synchronization Add-in](Outlook%20Add-in-\($%20P_1%20Product%20Name%20$\)%20Synchronization%20Add-in.md).  
  
-   SharePoint Online integration. For more information, see [Integrating with Microsoft Office](Integrating%20with%20Microsoft%20Office.md).  
...
## See Also  
 ...
 [Integrating with Microsoft Office](Integrating%20with%20Microsoft%20Office.md)   
 [Automated Data Capture System](Automated-Data-Capture-System.md)