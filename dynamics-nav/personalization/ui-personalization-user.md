...
1. In the upper-right corner, select the select the ![Settings](media/ui-experience/settings_icon_small.png "Settings icon for role center") icon, and then **Personalize**.
...
[Why the page is locked](ui-personalization-locked.md)  