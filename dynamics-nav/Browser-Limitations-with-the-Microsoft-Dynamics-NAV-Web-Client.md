...
The [!INCLUDE[nav_web](../dynamics-nav/includes/nav_web_md.md)] supports several browsers. There are some [!INCLUDE[navnow](../dynamics-nav/includes/navnow_md.md)] features that are not supported by all browsers.  
  
 For a list of the supported browsers and versions, see [System Requirements for Microsoft Dynamics NAV 2016](../dynamics-nav/System-Requirements-for-Microsoft-Dynamics-NAV-2016.md).  
  
## Feature Limitations  
 The following table describes the feature limitations and known issues with the supported browsers.  
  
> [!IMPORTANT]  
>  The [!INCLUDE[nav_web](../dynamics-nav/includes/nav_web_md.md)] is designed for keyboard and mouse usage. If you want to use a touch\-enabled device, we recommend running the [!INCLUDE[nav_uni_app](../dynamics-nav/includes/nav_uni_app_md.md)].  
...
|Windows authentication|Validating user credentials by using Windows authentication is not supported.|Safari|For more information about authentication and credentials, see [Users and Credential Types](../dynamics-nav/Users-and-Credential-Types.md).|  
