...
Adds actions to the menu bar of a page.  
 ...
 To open this window, open Page Designer, and then on the **View** menu, choose **Page Actions**. For more information about how to open Page Designer, see [\($ S\_21401 Page Designer $\)](uiref/-$-S_21401-Page-Designer-$-.md).  
