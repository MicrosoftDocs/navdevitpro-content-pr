 ...
 *Variable* can be inserted anywhere in *BigText* or added at the end of the *BigText*.  
 ...
 To delete the content in a *BigText* variable, use the [CLEAR Function](../dynamics-nav/CLEAR-Function.md). The following code shows the syntax for the function: `CLEAR(BigText)`  
