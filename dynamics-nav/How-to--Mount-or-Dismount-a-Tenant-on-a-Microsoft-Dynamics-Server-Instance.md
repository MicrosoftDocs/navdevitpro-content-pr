...
If a [!INCLUDE[nav_server](includes/nav_server_md.md)] instance is configured for multitenancy, then you can mount and dismount tenant databases by using the [!INCLUDE[nav_admin](includes/nav_admin_md.md)] or **Mount-NAVTenant** or **Dismount-NAVTenant** cmdlets in [!INCLUDE[nav_shell](includes/nav_shell_md.md)].  
 ...
 This topic describes how to use the [!INCLUDE[nav_admin](includes/nav_admin_md.md)] to mount or dismount a tenant. For more information about how to use the [!INCLUDE[nav_shell](includes/nav_shell_md.md)], see [T:Microsoft.Dynamics.Nav.Management.Cmdlets.Mount-NAVTenant](assetId:///T:Microsoft.Dynamics.Nav.Management.Cmdlets.Mount-NAVTenant) and [T:Microsoft.Dynamics.Nav.Management.Cmdlets.Dismount-NAVTenant](assetId:///T:Microsoft.Dynamics.Nav.Management.Cmdlets.Dismount-NAVTenant).  
...
4.  To mount a tenant, in the **Actions** pane, choose **Mount Tenant**, fill in the parameters on the **Mount Tenant** dialog box, and then choose the **OK** button.  
    ...
    |Database Name|Specifies the name of the [!INCLUDE[navnow](includes/navnow_md.md)] database that you want to mount on the [!INCLUDE[nav_server](includes/nav_server_md.md)] instance. For example, to mount the [!INCLUDE[demolong](includes/demolong_md.md)], specify **Demo Database NAV \(9-0\)**.|Yes|  
