...
By default, the size of a control add-in on a page is determined by the [System.Drawing.Size](/search/?search=System.Drawing.Size&dataSource=previousVersions) class of the control. The size is static, so when the page is resized in the [!INCLUDE[nav_windows](includes/nav_windows_md.md)], the control add-in size will remain the same.  
  
## Changing the Size of a Control Add-in  
 To change the size of the control add-in and set it to resize with the page window size, you implement the [WinFormsControlAddInBase.ApplySize](/search/?search=Microsoft.Dynamics.Framework.UI.Extensibility.WinForms.WinFormsControlAddInBase.ApplySize(Microsoft.Dynamics.Framework.UI.Extensibility.WinForms.DisplaySize,Microsoft.Dynamics.Framework.UI.Extensibility.WinForms.DisplaySize)&dataSource=previousVersions) method. This method has the following syntax.  
  
```c#  
public void ApplySize(DisplaySize width, DisplaySize height);  
```  
  
 Each dimension is defined by the [DisplaySize](/search/?search=Microsoft.Dynamics.Framework.UI.Extensibility.WinForms.DisplaySize&dataSource=previousVersions) method. This method has the following syntax.  
...
## Calling the ApplySize Method  
 You can use the [WinFormsControlAddInBase.ApplySize](/search/?search=Microsoft.Dynamics.Framework.UI.Extensibility.WinForms.WinFormsControlAddInBase.ApplySize(Microsoft.Dynamics.Framework.UI.Extensibility.WinForms.DisplaySize,Microsoft.Dynamics.Framework.UI.Extensibility.WinForms.DisplaySize)&dataSource=previousVersions) method multiple times in the control add-in code to change the width and height. However, you should use it as part of the [CreateControl](/search/?search=Microsoft.Dynamics.Framework.UI.Extensibility.WinForms.WinFormsControlAddInBase.CreateControl&dataSource=previousVersions) method.  
