...
|**SQLDataType**|The data type assigned to code fields.|  
 ...
 You must create a tabular-type page to access the **Field** table. For more information, see [How to: Create a Page to View a Virtual Table](How-to--Create%20a%20Page%20to%20View%20a%20Virtual%20Table.md).  
