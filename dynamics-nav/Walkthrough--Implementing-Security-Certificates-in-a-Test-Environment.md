...
-   The makecert.exe utility or the  Powershell Cmdlet [New-SelfSignedCertificate](/azure/active-directory/develop/howto-create-self-signed-certificate).  
     ...
     The makecert.exe utility is installed with Microsoft Visual Studio and Microsoft Windows SDK. For more information, see [Makecert](/windows/desktop/SecCrypto/makecert). The procedures in the walkthrough use makecert. 
