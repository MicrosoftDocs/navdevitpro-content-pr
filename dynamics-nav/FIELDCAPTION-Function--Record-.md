...
## Remarks  
 The **FIELDCAPTION** function returns the caption of a specified field. **FIELDCAPTION** searches for a [CaptionML Property](CaptionML-Property.md). If none is found, the [Name Property](Name-Property-duplicate.md) is used. This means that **FIELDCAPTION** has multilanguage functionality.  
