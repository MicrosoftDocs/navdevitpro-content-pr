...
|Upgrading [!INCLUDE[navnowlong](includes/navnowlong_md.md)] to a new platform version with no application changes, such as a cummulative update|<ul><li>[Converting a Database](Converting-a-Database.md)</li></ul>|  
