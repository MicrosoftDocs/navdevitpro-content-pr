...
> [!TIP]
> To get information about registered table connections, use the [Get-NAVTableConnection cmdlet](/powershell/module/microsoft.dynamics.nav.management/new-navtableconnection).
...
When done using an external table connection or if the connection must be refreshed, it can be unregistered by using either the UNREGISTERTABLECONNECTION function or the [Remove-NAVTableConnection cmdlet](/powershell/module/microsoft.dynamics.nav.management/remove-navtableconnection). 
...
> [!TIP]
> To get information about registered table connections, use the [Get-NAVTableConnection](/powershell/module/microsoft.dynamics.nav.management/get-navtableconnection) cmdlet.
