...
```
New-NAVTableConnection -ServerInstance <mynavserverinstance> -ConnectionType ExternalSQL -ConnectionId '<MyExternalConnectionName>' -DatabaseServer '<mydbserver>\<mydbinstance>' -DatabaseName '<myexternaldb>*
```
