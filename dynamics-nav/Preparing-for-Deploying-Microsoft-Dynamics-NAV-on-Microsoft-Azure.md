...
|----------|---------------------------------------|  
|Sign up for a Microsoft account.|You use a Microsoft account to sign in to the Azure management portal.<br /><br /> For more information, see [How to: Sign Up for a Microsoft Account](How%20to:%20Sign%20Up%20for%20a%20Microsoft%20Account.md).|  
|Sign up for an Azure subscription.|The Azure subscription gives you access to the Azure management portal.<br /><br /> For more information, see [How to: Sign Up for a Microsoft Azure Subscription](How%20to:%20Sign%20Up%20for%20a%20Microsoft%20Azure%20Subscription.md).|  
