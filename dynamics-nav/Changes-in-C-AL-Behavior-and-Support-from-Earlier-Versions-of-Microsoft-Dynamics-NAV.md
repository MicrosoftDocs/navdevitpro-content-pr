...
|-|--------------|---------------------------------------|  
|New Functions|[ADDACTION Function \(Notification\)](function-notificationaddaction.md)|Specifies an action for the notification.|  
...
## C/AL Triggers  
 The following table lists the new, changed, and removed triggers in [!INCLUDE[navnowlong](includes/navnowlong_md.md)].  

||Trigger|[!INCLUDE[bp_tabledescription](includes/bp_tabledescription_md.md)]|  
|-|--------------|---------------------------------------|  
|New Triggers|[OnAfterTestRun Trigger](trigger-onaftertestrun.md)|Executed after a test function of a test codeunit has been run.|
