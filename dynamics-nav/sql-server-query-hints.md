...
For more information about configuring the [!INCLUDE[nav_server](includes/nav_server_md.md)] instance, see [Configuring Business Central Server](configure-server-instance.md#Database).
