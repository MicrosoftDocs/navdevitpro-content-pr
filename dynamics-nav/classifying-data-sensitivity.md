...
The following table describes the data sensitivity classifications you can assign.
...
> [!Tip]
> We have defined sample sensitivity classifications for the tables and fields in the Cronus demonstration company. This data and sensitivity classifications are provided for demonstration purposes only. Please do not use them in a live production environment. You can, however, use the classifications as inspiration when you classify your own tables and fields. 
