...
description: Overview of Tables
ms.custom: na
ms.date: 06/05/2016
ms.reviewer: na
ms.suite: na
...
The records in the database are stored in tables. A table can be visualized as a two-dimensional matrix, consisting of columns and rows. The following illustration shows a table where each row is a record and each column is a field.  
 ...
 ![the table data and the table description together form a table](media/NAV_ADG_6_Diag_1.png "NAV\_ADG\_6\_Diag\_1")  
 ...
 ![a table description contains properties, triggers, fields, and keys](media/NAV_ADG_Diag_2.png "NAV\_ADG\_Diag\_2")  
