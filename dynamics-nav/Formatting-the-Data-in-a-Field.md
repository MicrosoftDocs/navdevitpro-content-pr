...
## Implementation Overview  
 ...
 You can see an example implementation of the AutoFormatType logic in the [!INCLUDE[demolong](../dynamics-nav/includes/demolong_md.md)]. In the [!INCLUDE[demolong](../dynamics-nav/includes/demolong_md.md)], the **AutoFormatTranslate** trigger calls codeunit **45 AutoFormatManagement** which handles the formatting.  
