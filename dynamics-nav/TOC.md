...
## [Wrting Extension Install Code](developer/devenv-extension-install-code.md)
...
### [Benefits and Guidelines for using a Prefix or Suffix](apptest-prefix-suffix.md)
### [Testing your Extension](apptest-testingyourextension.md)
### [User Scenario Documentation](apptest-userscenario.md)
### [Restrictions on UI for Objects Exposed as Web Services](apptest-webservices.md)
### [Replacing OnBeforeCompanyOpen and OnAfterCompanyOpen](apptest-onbeforecompanyopen.md)
<!-- old
