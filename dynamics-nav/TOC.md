...
### [Monitoring Dynamics NAV Server Performance Counters](Microsoft-Dynamics-NAV-Performance-Counters.md)
### [Monitoring Dynamics NAV Server Events](Monitoring-Microsoft-Dynamics-NAV-Server-Events.md)
#### [Dynamics NAV Server Trace Events List](Microsoft-Dynamics-NAV-Server-Trace-Events.md)
#### [Dynamics NAV Server Admin and Operational Events List](Microsoft-Dynamics-NAV-Server-Events.md)
#### [Using Event Viewer to View Events](Monitoring-Microsoft-Dynamics-NAV-Server-Events-in-the-Windows-Event-Log.md) 
#### [Using Performance Monitor to Collect Event Trace Data](How-to--Use-Performance-Monitor-to-Collect-Event-Trace-Data.md)
#### [Using PerfView to Collect Event Trace Data](How-to--Use-PerfView-to-Collect-Event-Trace-Data.md)
#### [Using Logman to Collect Event Trace Data](How-to--Use-Logman-to-Collect-Event-Trace-Data.md)
#### [Using PowerShell to View Events](Monitoring-Microsoft-Dynamics-NAV-Server-Events-with-PowerShell.md)
