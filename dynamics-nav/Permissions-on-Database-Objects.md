...
This section provides an overview of permissions and permission sets in [!INCLUDE[navnowlong](../dynamics-nav/includes/navnowlong_md.md)]  
...
## Permissions  
 ...
 [!INCLUDE[nav_current_short](../dynamics-nav/includes/nav_current_short_md.md)] has a number of standard predefined security permission sets. You can use these permission sets as defined or you can change a permission sets to suit your particular needs. You can also create your own permission sets and assign them the permissions that you want.  
