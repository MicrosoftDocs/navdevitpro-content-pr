...
In [!INCLUDE[navnowlong](includes/navnowlong_md.md)], you can create extensions with the following object types:
 - Pages
 - Tables
 - Reports
 - XMLports
...
[Microsoft Dynamics NAV Extension Packages](microsoft-dynamics-nav-extension-packages.md)    
