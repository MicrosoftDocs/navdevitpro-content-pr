...
---
# Actions Overview
In [!INCLUDE[navnow](../dynamics-nav/includes/navnow_md.md)], actions are displayed at the top of each page in the ribbon or in the navigation pane. In this topic, you learn about different types of actions, and how you can enable users to quickly locate the actions they want to use.  
...
|Navigate|List, card, and task pages|Links to other pages in [!INCLUDE[navnow](../dynamics-nav/includes/navnow_md.md)].|Prices|  
|Reports|Role Center, list, card, and task pages|A list of available reports.|Customer Top 10 List|  
|New|List, card, Role Center pages, and task pages|Actions that appear under the New group. Opens a new [!INCLUDE[navnow](../dynamics-nav/includes/navnow_md.md)] document.|New sales invoice|  
...
## Types of Actions  
 The following sections describe actions available in the [!INCLUDE[nav_windows](../dynamics-nav/includes/nav_windows_md.md)] and [!INCLUDE[nav_web](../dynamics-nav/includes/nav_web_md.md)].  
...
### Navigate  
 The Navigate tab is displayed after Actions in the ribbon. Rather than providing tasks for the user, this tab provides additional information by taking the user to a specific page in [!INCLUDE[navnow](../dynamics-nav/includes/navnow_md.md)].  
...
### New Document  
 The New action is often displayed both in the Home tab and in the Actions tab. You can use this action to open new documents within [!INCLUDE[navnow](../dynamics-nav/includes/navnow_md.md)]. When you create a New action in Action Designer, you must use the NewDocumentItems SubType.  
...
### Home Items  
 ...
 The user Role Center is like a home page, and home items in the navigation pane are links to the user’s most useful list pages. For more information, see [Setting Up the Home Button and Home Items](../dynamics-nav/Setting-Up-the-Home-Button-and-Home-Items.md)  
...
### Activity Buttons  
 ...
 For more information, see [Creating Activity Buttons for the Navigation Pane](../dynamics-nav/Creating-Activity-Buttons-for-the-Navigation-Pane.md)  
