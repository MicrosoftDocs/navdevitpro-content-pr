...
**Applies to:** [!INCLUDE[nav2017](includes/nav2017.md)]. [Go to[!INCLUDE[nav2018_md](includes/nav2018_md.md)] version](Browser-Limitations-with-the-Microsoft-Dynamics-NAV-Web-Client-2017.md).
