...
You can view the results of the full synchronization in the **Integration Synchronization Jobs** window. For more information, see [How to: View Microsoft Dynamics CRM Synchronization Status](how-to-view-synchronization-status.md).  
...
You can view the results of the synchronization in the **Integration Synchronization Jobs** window. For more information, see [How to: View Dynamics CRM Synchronization Status](how-to-view-synchronization-status.md).  
...
You can view the results of the synchronization in the **Integration Synchronization Jobs** window. For more information, see [How to: View Microsoft Dynamics CRM Synchronization Status](how-to-view-synchronization-status.md).
