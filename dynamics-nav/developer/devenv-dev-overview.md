...
For more information on how to group a set of disparate project folders into one workspace, see [How to: Work with multiple AL project folders within one workspace](../../articles/devenv-multiroot-workspaces.md).
