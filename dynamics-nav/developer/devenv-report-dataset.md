...
### Example
The following example adds the `Customer` table as the data item and the `Name` field as a column to the report. For more information on creating a report, see [How to: Create a Report](devenv-howto-report-layout.md).
```
  dataset
    {
