...
> [!NOTE]
> You can have only one .xlf file per language. If you translate your extension to multiple languages, you must have a translation file per language. There is no enforced naming on the file, but a suggested good practice would be to name it <extensionname>.<language>.xlf.

## Running the extension
With the translated file stored in the `/Translations` folder, your extension will now display the translation selected.
