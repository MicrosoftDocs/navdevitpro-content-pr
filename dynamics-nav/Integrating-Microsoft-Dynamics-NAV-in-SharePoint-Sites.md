...
- If you want the app to apply to all tenants, then set the *tenant* parameter to *{HostUrl}*, such as <em>https://www.solutions.com/DynamicsNAV/?tenant={HostUrl}</em> or *https://www.solutions.com/DynamicsNAV/WebClient/?tenant={HostUrl}*(for [!INCLUDE[nav2017](includes/nav2017.md)] and earlier versions).  
