...
|-----------|---------------------------------------|  
|Left Outer Join|The resulting dataset contains every record from the upper data item table, even if a record does not have a matching value in the lower data item for fields that are linked by the [DataItemLink Property \(Query\)](../dynamics-nav/DataItemLink-Property--Query-.md).|  
...
## Remarks  
 ...
 For more information about data item links and SQL Advanced Option, see [Understanding Data Item Links](../dynamics-nav/Understanding-Data-Item-Links.md) and [SQL Advanced Options for Data Item Link Types](../dynamics-nav/SQL-Advanced-Options-for-Data-Item-Link-Types.md).