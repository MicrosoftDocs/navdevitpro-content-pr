...
description: "This topic describes the INIT function (Record), which initializes a record in a table by assigning default values to each field in the record."
ms.custom: na
ms.date: 06/05/2016
ms.reviewer: na
ms.suite: na
