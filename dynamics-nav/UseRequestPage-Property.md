...
## Remarks  
 ...
 You can override the setting of the UseRequestPage property at runtime by setting the *ReqWindow* parameter of the [REPORT.RUN Function](../dynamics-nav/REPORT.RUN-Function.md), [REPORT.RUNMODAL Function](../dynamics-nav/REPORT.RUNMODAL-Function.md), or [RUN Function \(XMLport\)](../dynamics-nav/RUN-Function--XMLport-.md).