...
|Reports|-   Report Builder for SQL Server 2016 to edit RDLC report layouts.<br />-   Microsoft Word 2013 or later to edit Word layouts.|  
...
|Additional software|-   Microsoft .NET Framework 4.5.2.<br />-   Windows PowerShell 3.0.<br />-    ASP.NET Core 1.0 Windows Hosting.|  
