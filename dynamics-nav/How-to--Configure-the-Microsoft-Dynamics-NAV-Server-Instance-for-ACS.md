...
6.  Restart the [!INCLUDE[nav_server](includes/nav_server_md.md)] instance.  
 ...
 The next steps are to configure your clients for ACS. For more information, see [How to: Configure the Microsoft Dynamics NAV Windows Client for ACS](How-to--Configure%20the%20Microsoft%20Dynamics%20NAV%20Windows%20Client%20for%20ACS.md) and [How to: Configure the Microsoft Dynamics NAV Web Client for ACS](How-to--Configure%20the%20Microsoft%20Dynamics%20NAV%20Web%20Client%20for%20ACS.md).  
