...
description: "This topic describes how to install the Microsoft Dynamics NAV Provisioning Tools for Microsoft Azure from files available in the WindowsPowerShellScripts folder on the Dynamics NAV installation media (DVD)."
author: jswymer
ms.custom: na
ms.date: 06/05/2016
ms.reviewer: na
