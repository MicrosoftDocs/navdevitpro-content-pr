...
>   
> - *Workflow Event*: An occurrence in the application that users in the client can select from the **Workflow** page to define workflow steps. For more information, see [Workflow](https://docs.microsoft.com/en-us/dynamics-nav-app/across-workflow) in the application Help.
