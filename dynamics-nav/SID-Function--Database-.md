...
## Remarks  
 ...
 This function runs only on the computer that is running [!INCLUDE[nav_server](../dynamics-nav/includes/nav_server_md.md)]. If you call this function from the client computer, then no action occurs.  
