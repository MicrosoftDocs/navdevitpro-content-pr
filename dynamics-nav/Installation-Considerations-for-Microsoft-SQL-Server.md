...
On SQL Server 2012/2014, `MAXDOP` can only be set on the instance level, changing an advanced server configuration option. 
...
#### Startup Options
Enable trace flags 1117 and 1118 as startup options for SQL Server 2012 or SQL Server 2014. For SQL Server 2016, these trace flags are enabled by default.
