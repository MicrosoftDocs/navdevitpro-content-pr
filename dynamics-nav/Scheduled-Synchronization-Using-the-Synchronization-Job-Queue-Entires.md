...
|Job Queue Entry|[!INCLUDE[bp_tabledescription](../Token/bp_tabledescription_md.md)]|Direction|Integration Table Mapping|  
|---------------------|---------------------------------------|---------------|-------------------------------|  
