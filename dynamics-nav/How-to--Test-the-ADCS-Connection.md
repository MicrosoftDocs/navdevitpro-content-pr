...
The following procedure demonstrates how to use Windows Services and Telnet to test your Automated Data Capture System connection. Before you can begin, you must install the ADCS component as part of a customized installation of [!INCLUDE[navnow](../dynamics-nav/includes/navnow_md.md)]. For more information, see [How to: Choose Components to Install](../Topic/How%20to:%20Choose%20Components%20to%20Install.md).  
...
2.  Right\-click the [!INCLUDE[navnow](../dynamics-nav/includes/navnow_md.md)] VT100Plugin service, and then choose **Properties**.  
...
3.  To specify the user account that the service can use to log on, choose the **Log On** tab.  
    ...
    > [!NOTE]  
    >  To complete testing, you must also add the same user to [!INCLUDE[navnow](../dynamics-nav/includes/navnow_md.md)], with an appropriate permission set. For more information, see [How to: Create Microsoft Dynamics NAV Users](../Topic/How%20to:%20Create%20Microsoft%20Dynamics%20NAV%20Users.md).  
...
2.  In the **Windows Logs** console tree, choose **Application**, and then locate event information for the [!INCLUDE[navnow](../dynamics-nav/includes/navnow_md.md)] VT100 Plugin.  
...
6.  Select a warehouse activity option. For example, enter **1** in the **Choose** field if you want to simulate working with pick documents.  
     ...
     You can review the data about warehouse picks in [!INCLUDE[navnow](../dynamics-nav/includes/navnow_md.md)]. For example, you can use the data in the [!INCLUDE[demolong](../dynamics-nav/includes/demolong_md.md)] to send information from and to [!INCLUDE[navnow](../dynamics-nav/includes/navnow_md.md)].  
  
    > [!NOTE]  
    >  To see the interaction between [!INCLUDE[navnow](../dynamics-nav/includes/navnow_md.md)] and ADCS, in [!INCLUDE[demoname](../dynamics-nav/includes/demoname_md.md)], you can use warehouse activities that are located in the White warehouse. It is preconfigured to use ADCS. For more information, see [\($ T\_14\_7700 Use ADCS $\)](../Topic/\($%20T_14_7700%20Use%20ADCS%20$\).md).  
