...
|Understand mapping limitations for option values in [!INCLUDE[crm](includes/crm_md.md)] and learn how to make simple extensions to enable missing option values for automatic synchronization.|[Handling Missing Option Values](Handling Missing Option Values in Mapping.md)|
