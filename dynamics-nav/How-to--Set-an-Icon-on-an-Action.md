...
The [!INCLUDE[nav_windows](../dynamics-nav/includes/nav_windows_md.md)] includes images that you can use on actions in command bar menus and promoted actions on the ribbon.  
...
> [!NOTE]  
>  For information on using images on activity buttons in the navigation pane of the [!INCLUDE[nav_windows](../dynamics-nav/includes/nav_windows_md.md)], see [How to: Set an Icon on an Activity Button](../Topic/How%20to:%20Set%20an%20Icon%20on%20an%20Activity%20Button.md).  
...
7.  In the Image List window, select the image that you want to use for the action, and then choose the **OK** button.  
     ...
     To view the available images, see [Action Icon Library](../dynamics-nav/Action-Icon-Library.md).  
