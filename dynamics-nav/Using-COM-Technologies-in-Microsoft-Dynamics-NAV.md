...
|---------------------|-------------------|-------------|  
|[Boolean Data Type](../dynamics-nav/Boolean-Data-Type.md)|VARIANT\_BOOL \(VT\_BOOL\)||  
|[Option Data Type](../dynamics-nav/Option-Data-Type.md)|long \(VT\_I4\)||  
|[Integer Data Type](../dynamics-nav/Integer-Data-Type.md)|long \(VT\_I4\)||  
|[BigInteger Data Type](../dynamics-nav/BigInteger-Data-Type.md)|long \(VT\_I4\)||  
|[Decimal Data Type](../dynamics-nav/Decimal-Data-Type.md)|CURRENCY \(VT\_CY\)|The CURRENCY type in COM is a special data type with a fixed point that has 15 digits to the left of the decimal point and 4 to the right. The Decimal type in C\/AL does not have a fixed point and can have a total of 18 digits. This could lead to rounding being performed when a Decimal type number is passed to a method that expects a CURRENCY. The server changes that number and returns it as a CURRENCY. No matter how many digits the original Decimal had to the right of the decimal point, the returned CURRENCY will have no more than 4 digits.|  
|[Char Data Type](../dynamics-nav/Char-Data-Type.md)|BSTR \(VT\_BSTR\)||  
|[Text Data Type](../dynamics-nav/Text-Data-Type.md)|BSTR \(VT\_BSTR\)||  
|[Code Data Type](../dynamics-nav/Code-Data-Type.md)|BSTR \(VT\_BSTR\)||  
|[Date Data Type](../dynamics-nav/Date-Data-Type.md)|DATE \(VT\_DATE\)||  
|[Time Data Type](../dynamics-nav/Time-Data-Type.md)|void \(VT\_VOID\)||  
|[DateTime Data Type](../dynamics-nav/DateTime-Data-Type.md)|DATE \(VT\_DATE\)||  
|[Automation Data Type](../dynamics-nav/Automation-Data-Type.md)|TypedObject, UntypedObject<br /><br /> \(VT\_DISPATCH\)||  
|[InStream](../dynamics-nav/InStream.md)|VT\_STREAM||  
|[OutStream](../dynamics-nav/OutStream.md)|VT\_STREAM||  
|[Variant Data Type](../dynamics-nav/Variant-Data-Type.md)|VARIANT \(VT\_VARIANT\)||  
...
|-------------------|---------------------|-------------|  
|VT\_UNKNOWN|[InStream and OutStream Data Types](../dynamics-nav/InStream-and-OutStream-Data-Types.md)|Only the IID\_IStream and IID\_SequentialStream interfaces are supported. If you pass any other IUnknown interface, an error will occur at runtime.|  
|short \(VT\_I2\)|[Integer Data Type](../dynamics-nav/Integer-Data-Type.md)||  
|long \(VT\_I4\)|[Integer Data Type](../dynamics-nav/Integer-Data-Type.md)<br /><br /> [BigInteger Data Type](../dynamics-nav/BigInteger-Data-Type.md)||  
|float \(VT\_R4\)|[Decimal Data Type](../dynamics-nav/Decimal-Data-Type.md)||  
|double \(VT\_R8\)|[Decimal Data Type](../dynamics-nav/Decimal-Data-Type.md)||  
|CURRENCY \(VT\_CY\)|[Decimal Data Type](../dynamics-nav/Decimal-Data-Type.md)|The CURRENCY type in COM is a special data type with a fixed point, which has 15 digits to the left of the decimal point and 4 to the right. The Decimal type does not have a fixed point and can have a total of 18 digits.|  
|DATE \(VT\_DATE\)|[Date Data Type](../dynamics-nav/Date-Data-Type.md)<br /><br /> [DateTime Data Type](../dynamics-nav/DateTime-Data-Type.md)|The COM DATE type contains both a date and a time value. C\/AL has Date and Time as separate data types. Therefore, the time part of a COM DATE type will be lost when the COM DATE type is mapped to the Date C\/AL data type.<br /><br /> To keep the date and the time, map the COM Date type to the C\/AL DateTime data type.|  
|BSTR \(VT\_BSTR\)|[Text Data Type](../dynamics-nav/Text-Data-Type.md)||  
|VARIANT\_BOOL<br /><br /> \(VT\_BOOL\)|[Boolean Data Type](../dynamics-nav/Boolean-Data-Type.md)||  
|TypedObject\/<br /><br /> UntypedObject<br /><br /> \(VT\_DISPATCH\)|[Automation Data Type](../dynamics-nav/Automation-Data-Type.md)<br /><br /> [OCX Data Type](../dynamics-nav/OCX-Data-Type.md)||  
|VT\_EMPTY|[Text Data Type](../dynamics-nav/Text-Data-Type.md)||  
|VARIANT<br /><br /> \(VT\_VARIANT\)|[Variant Data Type](../dynamics-nav/Variant-Data-Type.md)||  
