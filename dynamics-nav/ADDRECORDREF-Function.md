...
## Remarks  
 In the filter page that is rendered in the [!INCLUDE[navnow](../dynamics-nav/includes/navnow_md.md)] client, the ADDRECORDREF function defines a filter control for the specified table where the user can add and set the filters on the table.  
