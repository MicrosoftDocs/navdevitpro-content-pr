...
5.  If [!INCLUDE[crm_md](includes/crm_md.md)] synchronization is not already set up, you will get a message that asks whether you want to use the default synchronization setup.  
