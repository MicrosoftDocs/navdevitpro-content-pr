...
Similar to other field controls on a page, a [!INCLUDE[nav_windows](includes/nav_windows_md.md)] control add-in can bind with data in the [!INCLUDE[navnow](includes/navnow_md.md)] database. This lets you create control add-ins that can display and update data in the database. Data binding is accomplished through [!INCLUDE[nav_server](includes/nav_server_md.md)] with the [SourceExpr Property](SourceExpr-Property.md) of the field control that is applied with the control add-in, as shown in the following illustration.  
 ...
 The control add-in must implement the Microsoft.Dynamics.Framework.UI.Extensibility.IValueControlAddInDefinition<!--(/search/index?dataSource=previousVersions&search=Microsoft.Dynamics.Framework.UI.Extensibility.IValueControlAddInDefinition--> interface that exposes the IValueControlAddInDefinition.Value<!--(/search/index?dataSource=previousVersions&search=Microsoft.Dynamics.Framework.UI.Extensibility.IValueControlAddInDefinition.Value--> property as shown in the following example for a DateTime data type.  
...
|---------------------|-------------------------------|  
|BigInteger|Int64<!--/search/index?dataSource=previousVersions&search=System.Int64-->|  
|BigText|String<!--/search/index?dataSource=previousVersions&search=System.String-->|  
|BLOB|Object<!--/search/index?dataSource=previousVersions&search=System.Object-->|  
|Boolean|Boolean<!--/search/index?dataSource=previousVersions&search=System.Boolean-->|  
|Byte|Byte<!--/search/index?dataSource=previousVersions&search=System.Byte-->|  
|Char|Char<!--/search/index?dataSource=previousVersions&search=System.Char-->|  
|Code|System.String<!--/search/index?dataSource=previousVersions&search=System.String-->|  
|Date|DateTime<!--/search/index?dataSource=previousVersions&search=System.DateTime-->|  
|DateFormula|String<!--/search/index?dataSource=previousVersions&search=System.String-->|  
|DateTime|DateTime<!--/search/index?dataSource=previousVersions&search=System.DateTime-->|  
|Decimal|Decimal<!--/search/index?dataSource=previousVersions&search=System.Decimal-->|  
|Duration|TimeSpan<!--/search/index?dataSource=previousVersions&search=System.TimeSpan-->|  
|Guid|Guid<!--/search/index?dataSource=previousVersions&search=System.Guid-->|  
|Integer|Int32<!--/search/index?dataSource=previousVersions&search=System.Int32-->|  
|Option|Int32<!--/search/index?dataSource=previousVersions&search=System.Int32-->|  
|RecordID|String<!--/search/index?dataSource=previousVersions&search=System.String-->|  
|Text|String<!--/search/index?dataSource=previousVersions&search=System.String-->|  
|Time|DateTime<!--/search/index?dataSource=previousVersions&search=System.DateTime-->|  
...
## Data Mapping and Multiple Data Types  
 ...
 A control add-in can support multiple .NET Framework data types by implementing the Microsoft.Dynamics.Framework.UI.Extensibility.IValueControlAddInDefinition<!--/search/index?dataSource=previousVersions&search=Microsoft.Dynamics.Framework.UI.Extensibility.IValueControlAddInDefinition--> interface for each data type. For example, to support both a string and an integer data type, include the following code.  
