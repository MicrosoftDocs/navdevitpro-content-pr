...
7.  Upload the [!INCLUDE[navcorfu](includes/navcorfu_md.md)] Partner license to the database  
     ...
     For more information, see [Uploading a License File for a Specific Database](How-to--Upload%20the%20License%20File.md#UploadtoDatabase).  
...
1.  Install [!INCLUDE[navcorfu](includes/navcorfu_md.md)].  
  
     Run the [!INCLUDE[navcorfu](includes/navcorfu_md.md)] Setup, and choose to install the **Developer** option.  
...
6.  Run the [!INCLUDE[nav_dev_short](includes/nav_dev_short_md.md)] as an administrator, and then set the [!INCLUDE[nav_dev_short](includes/nav_dev_short_md.md)] to use the [!INCLUDE[nav_server](includes/nav_server_md.md)] instance that connects to the database.  
     ...
     For more information, see [How to: Change the Microsoft Dynamics NAV Server Instance](How-to--Change%20the%20Microsoft%20Dynamics%20NAV%20Server%20Instance.md) or [\($ S\_2349 Database Information $\)](-$-S_2349-Database-Information-$-.md).  
...
11. Upload the customer license to the converted database.  
 ...
 Next, upgrade the application code to [!INCLUDE[navcorfu](includes/navcorfu_md.md)].  
