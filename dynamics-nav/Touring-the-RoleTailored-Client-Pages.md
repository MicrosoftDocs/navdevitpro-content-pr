...
In [!INCLUDE[navnow](../dynamics-nav/includes/navnow_md.md)], pages are the main way to display and organize data in the [!INCLUDE[rtc](../dynamics-nav/includes/rtc_md.md)]. You can create pages to offer users a visual experience that is closely aligned to Microsoft Office and Windows. There are different page types that you use for different situations. The page type that you choose depends on the application task that you want to support, the content that you want to display, and how you want to display it. For example, the Role Center page is the main page of the [!INCLUDE[rtc](../dynamics-nav/includes/rtc_md.md)] and it displays when the [!INCLUDE[rtc](../dynamics-nav/includes/rtc_md.md)] opens. The Role Center page is similar to a home page that helps users focus on their most important daily activities, by giving an overview of the information relevant to their tasks on one page. Other types of pages, such as List pages, display lists of customers or sales orders, while others such as Document task pages, focus on user tasks.  
  
> [!NOTE]  
>  The term [!INCLUDE[rtc](../dynamics-nav/includes/rtc_md.md)], which in [!INCLUDE[nav_2009_long](../dynamics-nav/includes/nav_2009_long_md.md)] referred only to the [!INCLUDE[nav_windows](../dynamics-nav/includes/nav_windows_md.md)], now the [!INCLUDE[rtc](../dynamics-nav/includes/rtc_md.md)] includes either the [!INCLUDE[nav_windows](../dynamics-nav/includes/nav_windows_md.md)] or the [!INCLUDE[nav_web](../dynamics-nav/includes/nav_web_md.md)].  
...
## Designing Pages  
 ...
 ![Page Designer overview](../dynamics-nav/media/NAV_PageDesigner.gif "NAV\_PageDesigner")  
...
|To|See|  
|--------|---------|  
|Learn how to use Page Designer to create pages.|[Pages](../dynamics-nav/Pages.md)|  
  
##  <a name="RoleCenterPage"></a> Role Center Page Type  
 The Role Center page is the main page of the [!INCLUDE[rtc](../dynamics-nav/includes/rtc_md.md)]. You can customize the Role Center page for the individual user. The Role Center page provides the user with an overview of the day’s work, where the user can quickly access information and tasks on which to focus for the day. The following illustration shows a Role Center page.  
  
 ![RoleTailored client RoleCenter page type example](../dynamics-nav/media/NAV_RoleCenterPageType.png "NAV\_RoleCenterPageType")  
...
|Get more information about FactBoxes.|[Adding a FactBox to Page](../dynamics-nav/Adding-a-FactBox-to-Page.md)|  
...
##  <a name="CardPartPage"></a> Card Part Page Type  
 ...
 ![RoleTailored client Card page example](../dynamics-nav/media/NAV_CardPartPage_SalesOrderList.jpg "NAV\_CardPartPage\_SalesOrderList")  
...
##  <a name="ConfirmationDialog"></a> ConfirmationDialog Page  
 ...
 ![RoleTailored client Confirmed Dialog page example](../dynamics-nav/media/NAV_ConfirmationDialogPage_CheckAvailability.jpg "NAV\_ConfirmationDialogPage\_CheckAvailability")  
...
##  <a name="DocumentPage"></a> Document Page Type  
 ...
 ![RoleTailored client Document page example](../dynamics-nav/media/NAV_DocumentPage_SalesOrder.jpg "NAV\_DocumentPage\_SalesOrder")  
...
##  <a name="ListPage"></a> List Page Type  
 ...
 ![RoleTailored client sales order List page example](../dynamics-nav/media/NAV_SalesOrderListPage.jpg "NAV\_SalesOrderListPage")  
...
|Learn more about List Places.|[Touring the RoleTailored Client Windows](../dynamics-nav/Touring-the-RoleTailored-Client-Windows.md)|  
|Get more information about FactBoxes.|[Adding a FactBox to Page](../dynamics-nav/Adding-a-FactBox-to-Page.md)|  
...
##  <a name="ListPlus"></a> List Plus Page Type  
 ...
 ![The List Plus Page type](../dynamics-nav/media/Client_ListPlusPageType.png "Client\_ListPlusPageType")  
...
##  <a name="ListPartPage"></a> List Part Page Type  
 ...
 ![RoleTailored client ListPart page example](../dynamics-nav/media/NAV_RoleCenter_ListPart.JPG "NAV\_RoleCenter\_ListPart")  
...
##  <a name="NavigatePage"></a> Navigate Page Type for Wizards  
 ...
 ![RoleTailored client Navigation pane wizard example](../dynamics-nav/media/NAV_NavigationPage_Wizard_ToDo.jpg "NAV\_NavigationPage\_Wizard\_ToDo")  
...
|Learn more about task pages.|[Touring the RoleTailored Client Windows](../dynamics-nav/Touring-the-RoleTailored-Client-Windows.md)|  
...
##  <a name="WorksheetPage"></a> Worksheet Page  
 ...
 ![RoleTailored client navigation page example](../dynamics-nav/media/NAV_WorksheetPage.jpg "NAV\_WorksheetPage")  
...
### Ribbon  
 ...
 ![Action Pane clip from a Customer List page](../dynamics-nav/media/NAV_CustomerList_ActionPaneFeatured.jpg "NAV\_CustomerList\_ActionPaneFeatured")  
...
|To|See|  
|--------|---------|  
|Learn more about actions and navigation.|[Adding Actions to Pages](../dynamics-nav/Adding-Actions-to-Pages.md)|  
...
###  <a name="Cue"></a> Cue  
 ...
 ![RoleTailored client cue example](../dynamics-nav/media/NAV_RoleCenterCueFeatured.jpg "NAV\_RoleCenterCueFeatured")  
...
### Chart Pane  
 ...
 ![RoleTailored client Chart part example](../dynamics-nav/media/NAV_RoleCenterChartPart.jpg "NAV\_RoleCenterChartPart")  
...
###  <a name="FactBox"></a> FactBox  
 ...
 ![RoleTailored client FactBox example](../dynamics-nav/media/NAV_FactBox_Featured.jpg "NAV\_FactBox\_Featured")  
...
###  <a name="FastTab"></a> FastTabs  
 ...
 ![RoleTailored client FastTab example](../dynamics-nav/media/NAV_FastTab_Featured.jpg "NAV\_FastTab\_Featured")  
...
### Filter Pane  
 ...
 ![RoleTailored client filter pane example](../dynamics-nav/media/NAV_FilterPane_Featured.jpg "NAV\_FilterPane\_Featured")  
...
### My Notifications  
 ...
 ![RoleTailored client MyNotifications part example](../dynamics-nav/media/NAV_RoleCenterMyNotifications_Featured.JPG "NAV\_RoleCenterMyNotifications\_Featured")  
...
### Notes  
 ...
 ![RoleTailored client Notes part example](../dynamics-nav/media/NAV_SalesOrder_NotesPart.jpg "NAV\_SalesOrder\_NotesPart")  
...
### RecordLinks  
 ...
 ![RoleTailored client recorded links example](../dynamics-nav/media/NAV_SalesOrder_RecordedLinks.jpg "NAV\_SalesOrder\_RecordedLinks")  
