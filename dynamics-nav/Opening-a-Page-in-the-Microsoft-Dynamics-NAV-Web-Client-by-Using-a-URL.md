...
|`profile`|Specifies the ID of the profile to open in [!INCLUDE[navnow](includes/navnow_md.md)]. For more information, see [How to: Open the Microsoft Dynamics NAV Web Client](../Topic/How%20to:%20Open%20the%20Microsoft%20Dynamics%20NAV%20Web%20Client.md).|  
