...
```  
http://MyWebServer:8080/nav_server_instance/WebClient/default.aspx?company=CRONUS-International-Ltd.&page=9305  
```  
...
-   Place parameters in any order after `aspx?` because the order is not important. For example, the following URLs will yield the same results.  
    ...
    ```  
    http://MyWebServer:8080/nav_server_instance/WebClient/default.aspx?company=CRONUS-International-Ltd.&page=9305&mode=View  
    ```  
  
    ```  
    http://MyWebServer:8080/nav_server_instance/WebClient/default.aspx?page=9305&mode=View&company=CRONUS-International-Ltd.  
    ```  
...
```  
http://MyWebServer:8080/nav_server_instance/WebClient/default.aspx?company=CRONUS-International-Ltd.&page=9305&filter='Sell-to-Customer-No.'-IS-'10000'-AND-'Location-Code'-IS-'BLUE'  
```  
