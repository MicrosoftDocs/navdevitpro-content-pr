...
The following sections provide an overview of the new, changed, and removed cmdlets in the [!INCLUDE[nav_shell](../dynamics-nav/includes/nav_shell_md.md)] and [!INCLUDE[nav_dev_shell](../dynamics-nav/includes/nav_dev_shell_md.md)] since the previous release.  
  
## Changes to [!INCLUDE[nav_shell](../dynamics-nav/includes/nav_shell_md.md)] Cmdlets  
...
> [!NOTE]  
>  A number of other new cmdlets are available in the [!INCLUDE[nav_shell](../dynamics-nav/includes/nav_shell_md.md)] but are not yet listed here. For a full list, see [Administration Cmdlets for Microsoft Dynamics NAV Extensions](http://go.microsoft.com/fwlink/?LinkID=626874).  
...
## Changes to [!INCLUDE[nav_dev_shell](../dynamics-nav/includes/nav_dev_shell_md.md)] Cmdlets  
...
> [!NOTE]  
>  A number of other new cmdlets are available in the [!INCLUDE[nav_dev_shell](../dynamics-nav/includes/nav_dev_shell_md.md)] but are not yet listed here. For a full list, see [Development Cmdlets for Microsoft Dynamics NAV Extensions](http://go.microsoft.com/fwlink/?LinkId=626875).  
