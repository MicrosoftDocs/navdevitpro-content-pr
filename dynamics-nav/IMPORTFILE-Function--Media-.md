...
-   A table that has the name **My Items** and the following characteristics (as a minimum):
    -   An **Integer** data type field that has the name **No.**.
        ...
        This field is used to specify an identifier to an item.
    -   A **Media** data type field that has the name **Image**.

        This is the field on which you will import the media file.
    - A field group that has the name **Brick** and includes the **ID** and **Image** fields.

        The field group is used to display the image on the page when the page is opened in the brick layout. For more information, see [How to: Display Data as Bricks](How-to--Display-Data-as-Bricks.md).
...
With the objects in place, you can add and run the following C/AL code to import the images. For this code example, create a codeunit and add the code to the **OnRun** trigger.
...
|Text constant name|ConstValue|Subtype|
|-------------------|--------------|-------------|
