...
|Modern Development Environment|Adds the AL development environment capability.<br> After the installation is done, to use the AL Language extension, you must first install [Visual Studio Code](https://code.visualstudio.com/), then open Visual Studio Code, and from the **Extensions** menu, choose **Install from VSIX**, and then from the equivalent folder of `C:\Program Files(x86)\Microsoft Dynamics NAV\110\Modern Development Environment\` locate the ALLanguage.vsix file and install it.|To run both AL and C/SIDE see [Running C/SIDE and AL Side-by-Side](developer/devenv-running-cside-and-al-side-by-side.md)|  
