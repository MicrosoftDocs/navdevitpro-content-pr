---
title: PATCH Sales Quote Line method | Microsoft Docs
...
```json
PATCH https://graph.microsoft.com/beta/financials/companies/{id}/salesQuotes{id}/salesQuoteLines(documentId={id},sequence={number})
Content-type: application/json
