---
title: GET Purchase Invoice Line method | Microsoft Docs
...
## Response
If successful, this method returns a ```200 OK``` response code and purchaseInvoiceLine object in the response body.
