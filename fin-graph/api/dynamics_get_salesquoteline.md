---
title: GET Sales Quote Line method | Microsoft Docs
...
## Response
If successful, this method returns a ```200 OK``` response code and salesQuoteLine object in the response body.
