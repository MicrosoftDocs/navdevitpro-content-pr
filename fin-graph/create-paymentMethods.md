...
Create a paymentMethods in [!INCLUDE[d365fin_long_md](../dynamics-nav/includes/d365fin_long_md.md)].
...
```json
POST https://graph.microsoft.com/beta/finacials/companies/{id}/paymentMethods
Content-type: application/json
