...
## Remarks  
 ...
 The *FileName* parameter specifies a location on the computer that is running [!INCLUDE[d365fin_server](../includes/d365fin_server_md.md)]. If you call this method from a client, such as from an action on a page, then use the [DOWNLOAD Method \(File\)](devenv-DOWNLOAD-Method-File.md) to download the .pdf file from the computer that is running [!INCLUDE[d365fin_server](../includes/d365fin_server_md.md)] to the computer that is running the client.  
...
## Example  
 This example shows how to use the **SAVEASPDF** method to save a specific report as a PDF file on the computer that is running [!INCLUDE[d365fin_server](../includes/d365fin_server_md.md)]. It requires that you create the following variables.  
