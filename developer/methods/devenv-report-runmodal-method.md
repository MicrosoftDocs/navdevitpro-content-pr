...
> [!IMPORTANT]  
>  Client-side printing is not supported by [!INCLUDE[d365fin_web_md](../includes/d365fin_web_md.md)]. If you set this parameter to **false** and the report will be run on [!INCLUDE[d365fin_web_md](../includes/d365fin_web_md.md)], you must set up the report to print from [!INCLUDE[d365fin_server](../includes/d365fin_server_md.md)], otherwise an error occurs at runtime. For more information, see [How to: Specify Printer Selection for Reports](How-to--Specify-Printer-Selection-for-Reports.md) and [STARTSESSION Method \(Sessions\)](devenv-STARTSESSION-Method-Sessions.md).  
