...
|[DateFormula Data Type](devenv-dateformula-data-type.md)|Used to verify the date entered by the user. The syntax is for example:<br /><br /> `30D (=30 days)`<br /><br /> `CM+1M (=current month plus one month)`<br /><br /> `D15 (=on the 15th of each month)`|32 bytes|  
